...
<head>
	...
	<@uri.script src=
	["/disabClientConvert_chart.js","/disabClientConvert_data.js"
	]/>
</head>
<body>
...
<div class="main">
	...
	<div id="html_data">
		<#include 'disabClientConvert_data.ftl'/>
	</div>
	
	<#include '../include/disabClientConvert_quota_explain.ftl'>
</div>
<!-- main end-->
...
$(function(){
	...
	$("#query_button").click(function (){
		...
		ajaxRequest(
				{
					url:path+'/auth/dcc/loadData.htm',
			        postMethod:'POST',
			        params:params,
			        session_out:false,
