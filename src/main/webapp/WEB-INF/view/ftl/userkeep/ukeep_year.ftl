...
<div class="main3">
	<ul class="filter_a clearfix" style="margin-left: 35px;">
		<li>年份：
			<select name="yearSelect" id="yearSelect" class="bar1"></select>
		</li>
	</ul>
	<!-- 访问渠道 begin -->
	<div class="filter_b" style="min-width:1100px;">
		<dl class="fwqd">
			...
			<dd>
				<ul class="clearfix">
					<li class="current" wd="newtrade-y"><a href="javascript:void(0)" target="_self">新增交易用户</a></li>
					<li wd="newuser-y"><a href="javascript:void(0)" target="_self">新开户用户</a></li>
				</ul>
			</dd>
		</dl>
		<div class="fw" id="qudaoChoose"></div>
		<dl class="mt10 clearfix">
			<a href="javascript:void(0);" target="_self" class="btn-style-b btn2" style="float:right;" id="submit">确定</a>
		</dl>
	</div>
	<!-- 访问渠道 end -->
	<!-- 公募开户渠道 begin -->
	<div class="chartbox hb-chart" id="ukeepGraphDetail"></div>
</div>
<!-- main end-->
</body>
