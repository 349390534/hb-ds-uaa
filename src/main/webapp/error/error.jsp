...
<div class="column">
    ...
    <div class="body buletored">
        <div class="iocn">对不起，系统繁忙，请稍后再试！返回 <a href="http://www.howbuy.com/">好买首页</a></div>
        <div>
            <p>您可以快速地访问以下页面：</p>
            <ul>
                ...
                <li><a href="#" onClick="document.getElementById('allMsg').style.display='inline'">详情</a></li>
            </ul>
            <p>&nbsp;</p>
        </div>
    </div>
</div>
<table id="allMsg" style="display:none">
    <tr>
        <td>
            <% if (exception != null) { %>
