...
public class HttpGetPost {
	...
	/**
	 * 从指定的URL获取返回的数据(线程安全O)
	 * @param requestUrl
	 * @param charset
	 * @return
	 * @throws IOException
	 */
	public static synchronized String getStringFromUrl(String requestUrl,String charset) 
			throws IOException{
		String result = null;
		...
		byte[] bsArray = baos.toByteArray();
		result = new String(bsArray,charset);
		return result;
	}
}
